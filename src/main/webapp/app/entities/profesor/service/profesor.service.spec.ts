...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../profesor.test-samples';

import { ProfesorService } from './profesor.service';

const requireRestSample: IProfesor = {
...
describe('Profesor Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Profesor', () => {
      ...
      const profesor = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(profesor).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Profesor', () => {
      const profesor = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(profesor).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addProfesorToCollectionIfMissing', () => {
      it('should add a Profesor to an empty array', () => {
        const profesor: IProfesor = sampleWithRequiredData;
      ...
      it("should add a Profesor to an array that doesn't contain it", () => {
        const profesor: IProfesor = sampleWithRequiredData;
        const profesorCollection: IProfesor[] = [sampleWithPartialData];
        expectedResult = service.addProfesorToCollectionIfMissing(profesorCollection, profesor);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(profesor);
      });
      ...
      it('should add only unique Profesor to an array', () => {
        const profesorArray: IProfesor[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const profesorCollection: IProfesor[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const profesor: IProfesor = sampleWithRequiredData;
        const profesor2: IProfesor = sampleWithPartialData;
    ...
    describe('compareProfesor', () => {
      it('Should return true if both entities are null', () => {
        ...
        const compareResult = service.compareProfesor(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareProfesor(entity1, entity2);
        const compareResult2 = service.compareProfesor(entity2, entity1);
