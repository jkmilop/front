...
type ProfesorFormGroupContent = {
  ...
  profesorName: FormControl<IProfesor['profesorName']>;
  codigoProfesor: FormControl<IProfesor['codigoProfesor']>;
...
export class ProfesorFormService {
  createProfesorFormGroup(profesor: ProfesorFormGroupInput = { id: null }): ProfesorFormGroup {
    ...
    return new FormGroup<ProfesorFormGroupContent>({
      ...
      profesorName: new FormControl(profesorRawValue.profesorName),
      codigoProfesor: new FormControl(profesorRawValue.codigoProfesor),
