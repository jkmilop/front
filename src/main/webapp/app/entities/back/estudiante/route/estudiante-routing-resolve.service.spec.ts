...
describe('Estudiante routing resolve service', () => {
  ...
  let resultEstudiante: IEstudiante | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultEstudiante).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IEstudiante>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
